...
<div class="container">
    <div class="card">
        <div class="card-header text-white bg-primary">
            <h4 class="card-title">
                Edit Mobil - <?php echo  $hasil['merk'];?>
        ...
        <div class="card-body">
            <div class="container">
                <form method="post" action="proses.php?aksi=edit&id=<?php echo  $id;?>" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" value="<?php echo  $hasil['no_plat'];?>" name="no_plat" placeholder="Isi No Plat">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Merk Mobil</label>
                                <input type="text" class="form-control col-sm-9"  value="<?php echo  $hasil['merk'];?>" name="merk" placeholder="Isi Merk">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Harga</label>
                                <input type="text" class="form-control col-sm-9"  value="<?php echo  $hasil['harga'];?>" name="harga" placeholder="Isi Harga">
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9"  value="<?php echo  $hasil['deskripsi'];?>" name="deskripsi" placeholder="Isi Deskripsi">
                            </div>
                            ...
                            <input type="hidden" value="<?php echo  $hasil['gambar'];?>" name="gambar_cek">
                        </div>
                    </div>
                    <hr>
                    <div class="float-right">
