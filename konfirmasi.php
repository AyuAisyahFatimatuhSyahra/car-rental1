         ...
         <div class="card">
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=konfirmasi">
                    ...
                    <button type="button" class="btn btn-primary float-right" onclick="konfirmasi()">Kirim</button>

                    <script>
                    function konfirmasi() {
                        if (confirm("Menunggu konfirmasi dari admin.\nKlik 'OK' untuk kembali ke beranda.")) {
